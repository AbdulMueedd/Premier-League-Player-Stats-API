package com.pl.primerleague.player;
...
public class Player{
    ...
    @Id
    @Column(name = "name") // you renamed player_name -> name
    private String name;
    ...
    private String pos;  // Java field can be pos, DB column is position
    ...
    public Double getXast() { return xast; }
    public void setXast(Double xast) { this.xast = xast; }
